    ...
    stages {
        ...
        */
        stage('Test') {
            steps {
                sh 'pwd'
                docker-compose -f dockerCompose/docker-compose.yml  run -it unittests dotnet test code/test/Caracal.Assess.Application.Tests.Unit/Caracal.Assess.Application.Tests.Unit.csproj                                                                                                                                                
            }
        }
        /*
        stage('Login') {
